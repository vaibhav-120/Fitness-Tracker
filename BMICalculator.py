...
class BMI():
    def __init__(self):
        ...
        self.right_top_panel = Frame(self.mainframe,width=750,height=435,bg="white")
        ...
        self.img2lbl.place(x=50,y=140)

        self.info1lbl = Label(self.right_top_panel,text="Underweight",font="Arial 10 bold",bg="white")
        self.info1lbl.place(x=300,y=140)
        self.infofrm = Frame(self.right_top_panel,bg="#3487FF",width=20,height=20)
        self.infofrm.place(x=400,y=140)
        
        self.info2lbl = Label(self.right_top_panel,text="Normal",font="Arial 10 bold",bg="white")
        self.info2lbl.place(x=300,y=180)
        self.info2frm = Frame(self.right_top_panel,bg="#4FA84F",width=20,height=20)
        self.info2frm.place(x=400,y=180)
        
        self.info3lbl = Label(self.right_top_panel,text="Overweight",font="Arial 10 bold",bg="white")
        self.info3lbl.place(x=300,y=220)
        self.info3frm = Frame(self.right_top_panel,bg="#F33B3B",width=20,height=20)
        self.info3frm.place(x=400,y=220)


        self.right_bottom_panel = Frame(self.mainframe,width=750,height=150,bg="white")
        self.right_bottom_panel.place(x=550,y=485)

        self.loglbl = Label(self.right_bottom_panel,text="Already have an account?",font="Arial 20 bold",bg="white")
        self.loglbl.place(x=30,y=20)
        self.loginbtn = Button(self.right_bottom_panel,text="Log in",font="Arial 12 bold",command=self.loginfn)
        self.loginbtn.place(x=50,y=70)
    ...
    def calculate(self):
        ...
        if type(age) == int and type(height) == int and type(weight) == int:
            ...
            if health == "Severe Thinness" or health == "Moderate Thinness" or health == "Mild Thinness":
                ...
                self.imginfo1lbl.place(x=50,y=140)
                self.textdisplay = "Do you want to gain weight?"
                self.logbtn = Button(self.right_bottom_panel,text="Join Now",width=10,bg="#2d2e3d",fg="white",font="Arial 12 bold",command=self.logfnc)
                self.logbtn.place(x=350,y=80)
            elif health == "Normal":
                ...
                self.imginfo2lbl.place(x=50,y=140)
                self.textdisplay = "What you want to do?"
                self.log1btn = Button(self.right_bottom_panel,text="Gain Weight",width=10,bg="#2d2e3d",fg="white",font="Arial 12 bold",command=self.logfnc)
                self.log1btn.place(x=350,y=80)
                self.log2btn = Button(self.right_bottom_panel,text="Loose weight",width=10,bg="#2d2e3d",fg="white",font="Arial 12 bold",command=self.logfnc)
                self.log2btn.place(x=500,y=80)
            else:
                ...
                self.imginfo3lbl.place(x=50,y=140)
                self.textdisplay = "Do you want to loose weight?"
                self.logbtn = Button(self.right_bottom_panel,text="Join Now",width=10,bg="#2d2e3d",fg="white",font="Arial 12 bold",command=self.logfnc)
                self.logbtn.place(x=350,y=80)
            

            self.desc_lbl = Label(self.right_top_panel,text="Result",font="Arial 25 bold",bg="white")
            self.desc_lbl.place(x=500,y=300)
            self.reslbl = Label(self.right_top_panel,text="Your BMI is :",bg="white",font="Arial 15 bold")
            self.reslbl.place(x=500,y=350)
            self.bmilbl = Label(self.right_top_panel,text=self.bmi,font="Arial 15 bold",bg="white")
            self.bmilbl.place(x=650,y=350)

            self.condition1lbl = Label(self.right_bottom_panel,text=health,bg="white",font="Arial 30 bold")
            self.condition1lbl.place(x=20,y=20)
            self.condition2lbl = Label(self.right_bottom_panel,text=self.textdisplay,bg="white",font="Arial 15 bold")
            self.condition2lbl.place(x=20,y=80)
